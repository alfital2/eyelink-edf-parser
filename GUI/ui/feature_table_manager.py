"""
Feature Table Manager for Eye Movement Analysis

Manages the creation, organization, and updates of feature tables in the GUI.
Provides functionality for displaying different categories of eye tracking metrics.
"""
...
# Updated import path for feature definitions
from ..data.feature_definitions import FEATURE_CATEGORIES
