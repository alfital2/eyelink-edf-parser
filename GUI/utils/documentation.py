...
Contains explanations and documentation for eye movement features and visualizations
used in the Eye Movement Analysis for Autism Classification GUI.

This module centralizes all textual documentation to ensure consistent information
across the application and to simplify future updates to the documentation.
"""


def get_feature_explanations():
    """
    Return a dictionary of explanations for each eye tracking feature
    
    Returns:
        dict: Dictionary mapping feature IDs to their human-readable explanations
    """
    explanations = {
        # Pupil Size Features
...
def get_visualization_explanations():
    ...
    Returns:
        dict: Dictionary mapping visualization IDs to their HTML explanations
    """
    explanations = {
        "scanpath": """
...
def get_formatted_feature_documentation():
    ...
    Returns:
        str: HTML-formatted documentation about eye tracking features
    """
...
def get_formatted_visualization_documentation():
    ...
    Returns:
        str: HTML-formatted documentation about eye tracking visualizations
    """
