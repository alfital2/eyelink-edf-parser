    ...
    def setUpClass(cls):
        ...
        with open(cls.validation_file_path, 'w') as f:
            ...
            for amplitude in amplitudes:
                for line in cls.generator.generate_saccade("L", amplitude=amplitude, duration=50, peak_velocity=amplitude*10):
                    f.write(line + '\n')
            
            # Add exactly 3 right saccades with known amplitudes
            for amplitude in amplitudes:
                for line in cls.generator.generate_saccade("R", amplitude=amplitude, duration=50, peak_velocity=amplitude*10):
                    f.write(line + '\n')
